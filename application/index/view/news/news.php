					...
					<div class="force-overflow">
						<div class="container">
							<div class="row">
								<div>
									<ul class="row">
										<li class="news col-md-6 col-lg-6 ">
											<div>
												<div class="row">
													<div class="news_left  col-md-5 col-lg-5">
														<a href="news_details.html"><img src="img/news_details.jpg" /></a>
													</div>
													<div class="news_right  col-md-7 col-lg-7">
														<h6><a href="news_details.html">为什么可口可乐和百事在中国都不好卖了？</a></h6>
														<b>2016 07 29  00:13</b>
														<b>浏览：999</b>
														<b>来源：网络新闻</b>
														<p>据可口可乐最新财报数据，2016年上半年，可口可乐总营收218.21亿美元，
															同比下跌4.6%。可口可乐销售额的下跌主要受到了亚太区、尤其是中国市场的拖累；
															据金融时报报道，可口可乐首席运营官称司在中国果汁类同比下跌4.6%。
															可口可乐销...</p>
													</div>
												</div>
											</div>
